...
description: Meta skill — browse all installed solana-new skills, repos, and MCPs to find the right tool for any task. Use when a user says "what skills do I have", "show me available skills", "what can I build", "find a skill for", "which tool should I use", or "help me navigate".
---
